    ...
    def append(self, record: dict[str, Any]) -> bool:
        ...
        try:
            ...
            with self.path.open("a", encoding="utf-8") as fh:
                # Redact after serialising, so no field (a reason, an input) can carry a
                # key-bearing URL into quarantine.jsonl or sent_digests.jsonl.
                from whale_agent.redact import redact

                fh.write(redact(json.dumps(record, default=str, ensure_ascii=False)) + "\n")
            return True
